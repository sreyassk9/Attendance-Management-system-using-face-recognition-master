...
haarcasecade_path = "D:\Downloads\Attendance-Management-system-using-face-recognition-master (1)\Attendance-Management-system-using-face-recognition-master\haarcascade_frontalface_alt.xml"
...
titl = tk.Label(
    window, text="Smart School !!", bg="black", fg="green", font=("arial", 27),
)
